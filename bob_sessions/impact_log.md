...
> **Canonical location:** `bob_sessions/impact_log.md`
> The root-level `impact_log.md` redirects here.

---

## Original Bob Session Notes

The entries below are the raw notes written during each Bob session and committed
incrementally throughout the project. They are preserved verbatim as the primary
session record.
